...
const (
	...
	Auth_JWT_FullMethodName          = "/auth.Auth/JWT"
...
func (c *authClient) Ping(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (c *authClient) JWT(ctx context.Context, in *JwtRequest, opts ...grpc.CallOption) (*JwtResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JwtResponse)
	err := c.cc.Invoke(ctx, Auth_JWT_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) Ping(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func (UnimplementedAuthServer) JWT(context.Context, *JwtRequest) (*JwtResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method JWT not implemented")
}
...
func _Auth_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Ping(ctx, req.(*HelloRequest))
	}
...
func _Auth_JWT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(JwtRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).JWT(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_JWT_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).JWT(ctx, req.(*JwtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
